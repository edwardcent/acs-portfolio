...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'A love letter to the 1999 Seiko H Timetron. The concept and prototype for the ACS Timetron is our take on a cult classic.',
    image: 'watch.png',
    sections: [],
  },
  {
  ...
  },
  {
    ...
    title: 'T-Shirt Tech Pack for Counterfeit Studio',
    year: '2024',
    category: 'Tech Pack, Grading',
